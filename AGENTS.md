...
視聴者が離れやすい冒頭30秒は、単なるキャラ紹介ではなく「この動画で何を見られるのか」を一気に伝える。

- イントロ1本目は、キャラ名だけでなく「代表技・二つ名・初見で刺さる見どころ」を入れる。例: 豪炎寺なら「ファイアトルネードで空気を変えた炎のエース」。
- イントロ2本目は、視聴者が続きも見たくなる背景を短く出す。強さの説明だけでなく、離脱・復帰・因縁・約束・正体などの感情フックを入れる。
- イントロ3本目の後、最初の本編4セリフはテンポを落とさず、初登場や初必殺技など「一目で分かる衝撃」に集中する。
- 冒頭では抽象的な人気語りを避け、「ピッチに入った瞬間に空気が変わった」「初見の必殺技でエースだと分かった」のように、視聴者が当時の画面を思い出せる言い方にする。
- title.png と anime_01.png は特に重要。主人公の顔・構え・技・登場シーンが大きく見え、字幕なしでも題材が分かる画像を選ぶ。
- 最初の30秒に声優・制作事情・後続作品の話は入れない。キャラの魅力、当時の驚き、次の展開への期待だけで押す。
